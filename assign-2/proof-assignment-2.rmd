...
a. $P \lor Q$
    ...
    - By the rules of implication, $\neg P \rightarrow Q$ will be true whenever $P$
      is true. This accounts for the left side of the statement $P \lor Q$. When $P$ is
      false, the implication requries $Q$ to be true in order to be a true
      statement, thus perfectly replicating the original disjunct term, as the
      folowing truth table demonstrates.
